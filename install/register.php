...
if (!empty($email) && !empty($password)) {
	...
	$query = 'INSERT INTO users (login, email, password, role, registered, logged_in, logged_out, active, token)' .
	'         VALUES (:login, :email, :password, :role, NOW(), NOW(), NOW(), :active, :token)';
